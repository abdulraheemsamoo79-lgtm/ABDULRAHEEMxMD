/**
   * Create By ABDULRAHEEM OFFICIAL
   * Contact Me on 923308348707
*/
...
const initializeBot = async () => {
    ...
    console.log(chalk.green('   𝐀𝐛𝐝𝐮𝐥𝐑𝐚𝐡𝐞𝐞𝐦 𝐩𝐚𝐢𝐫𝐢𝐧𝐠 𝐬𝐲𝐬𝐭𝐞𝐦       '));
    console.log(chalk.yellow('═══════════════════════════════════════════════\n'));
...
function launchBot() {
    console.clear();
    console.log(chalk.green('🚀 Starting 𝐀𝐛𝐝𝐮𝐥𝐑𝐚𝐡𝐞𝐞𝐦 system...\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('✅𝐀𝐛𝐝𝐮𝐥𝐑𝐚𝐡𝐞𝐞𝐦 bot loaded successfully!'));
        } catch (error) {
    ...
    console.log(chalk.bold.white('𝐀𝐛𝐝𝐮𝐥𝐑𝐚𝐡𝐞𝐞𝐦 BOT INITIALIZATION SUMMARY          '));
    console.log(chalk.cyan('═══════════════════════════════════════════════'));
    console.log(telegramLoaded ? chalk.green('✅𝐀𝐛𝐝𝐮𝐥𝐑𝐚𝐡𝐞𝐞𝐦 тɛℓɛɢяαм вσт: Active') : chalk.red('❌𝐀𝐛𝐝𝐮𝐥𝐑𝐚𝐡𝐞𝐞𝐦 тɛℓɛɢяαм вσт : Inactive'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ 𝐀𝐛𝐝𝐮𝐥𝐑𝐚𝐡𝐞𝐞𝐦 system is ready and running!\n'));
    }
