...
const sendChannelsRequiredMessage = async (chatId) => {
  return bot.sendMessage(chatId,
    `🚨 *You must join our official channels before pairing.*`,
    {
      ...
      reply_markup: {
        inline_keyboard: [
          [{ text: '📢 Channel 1', url: 'https://t.me/abdulraheemXmd' }],
          [{ text: '📢 Channel 2', url: 'https://t.me/arXprimeMDv1' }],
          [{ text: '👥 Group', url: 'https://t.me/+1tcQzj1quSM4ODk0' }],
...
bot.onText(/\/start/, async (msg) => {
  ...
  await bot.sendPhoto(
    ...
    "https://i.postimg.cc/XNm38Zdg/file-000000004c1c8246a43ff13964708f94.png",
    {
      ...
      reply_markup: {
        inline_keyboard: [
          [{ text: "👑 Owner", url: "https://t.me/arXprimeLegend" }]
        ]
      }
    }
  );
...
(async () => {
  ...
  console.log('✅ Bot Username: @RAHEEMxMD_bot');
